UPDATE `creature_template` SET `MovementType`='0' WHERE (`entry`='37533');
UPDATE `creature_template` SET `MovementType`='0' WHERE (`entry`='37534');


UPDATE `gameobject_template` SET `data2`='99999999' WHERE (`entry`='201959');
UPDATE `gameobject_template` SET `data2`='0', `data10`='1', `data12`='1', `data13`='1' WHERE (`entry`='201959');

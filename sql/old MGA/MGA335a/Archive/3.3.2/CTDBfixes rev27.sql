...
INSERT INTO `game_event_condition` (`event_id`, `condition_id`, `req_num`, `max_world_state_field`, `done_world_state_field`, `description`) VALUES (47, 1, 1e006, 0, 0, '');
...
-- Eye of Acherus
-- Is very slow moving need much speed
UPDATE creature_template SET speed='3' WHERE `entry`=28511;

-- Koltira Deathweaver
-- This NPC need to be inmmuity to some effects
...
-- Orbaz Bloodbane 
-- In our DB is death but need to be on live
UPDATE `creature_template` SET `type_flags`='6152', `Health_mod`='500', `spell2`='50688', `spell4`='0' WHERE `entry`=29204;
...
-- Contributin To The Cause http://www.wowhead.com/?quest=13846
-- This quest is giving 10.000 rep points and can only give 100
UPDATE `quest_template` SET `RewRepValue1`=100 WHERE `entry`=13846; 
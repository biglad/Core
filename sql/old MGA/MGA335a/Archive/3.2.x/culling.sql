...
(3099600,30996,8,0,100,1,49590,-1,0,0,33,30996,6,0,41,0,0,0,0,0,0,0, 'Kill CreditEAi Support');
UPDATE `quest_template` SET `ReqCreatureOrGOCount1`=5, `ReqSpellCast1`=0 WHERE 
`entry`=13149;

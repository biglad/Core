...
SET @creature_id := "600002"; 		-- unique entry
SET @creature_name := "Prof Master"; 	-- NPC's name
SET @creature_subname := "All Skills"; 	-- subname
SET @creature_displayid := 16625; 	-- display ID of NPC
SET @trainer_id := 997; 		-- should be unique to avoid conflicts
SET @trainer_type := 2; 		-- trainer type
		-- 0 is class trainer, 
		-- 1 is mount trainer, 

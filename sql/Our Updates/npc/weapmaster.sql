...
SET @creature_id := "600000"; 		-- unique entry
SET @creature_name := "Weapon Master"; 	-- NPC's name
SET @creature_subname := "All Skills"; 	-- subname
SET @creature_displayid := 16625; 	-- display ID of NPC
SET @trainer_id := 999; 		-- should be unique to avoid conflicts
SET @trainer_type := 3; 		-- trainer type
		-- 0 is class trainer, 
		-- 1 is mount trainer, 
